...
Como vimos en la presentación, [**Quarto**](https://quarto.org/) es un sistema moderno de creación de documentos dinámicos, informes, presentaciones, libros, sitios web y más, a partir de archivos de texto plano y por medio del conversor universal de documentos [**Pandoc**](https://pandoc.org/). Está especialmente diseñado para elaborar documentos científicos y técnicos reproducibles.
